...
void mis_log::set_config(::mmwis::MISConfig & config) {
    log_config = config; 
}
...
void mis_log::print_reduction(::mmwis::MISConfig & mis_config, unsigned int extracted_nodes, unsigned int kernel_size) {
...
void mis_log::set_best_size(::mmwis::MISConfig & mis_config, unsigned int size) {
