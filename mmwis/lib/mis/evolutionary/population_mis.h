...
class population_mis {
    public:
         ...
         */
        void get_random_individuum(MISConfig & config, individuum_mis & ind);
         ...
         */
        NodeWeight create_solution(graph_access & G, NodeID *solution);
         ...
         * @return Average solution size.
         */
        double get_avg_solution_weight();
         ...
         */
        void get_best_individual_nodes(MISConfig & config, graph_access & G, std::vector<NodeID> & nodes, std::vector<NodeID> & nodes_excluded);
