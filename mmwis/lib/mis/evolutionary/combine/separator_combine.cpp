...
separator_combine::separator_combine(const MISConfig& config) : config(config), local(config) {
...
void separator_combine::combine(MISConfig & config, graph_access & G, separator_pool *pool, individuum_mis & first, individuum_mis & second, individuum_mis & out_first, individuum_mis & out_second) {
    ...
    NodeWeight solution_first_weight = pop.create_solution(G, solution_first);
    out_first.solution = solution_first;
    out_first.solution_weight = solution_first_weight;
    ...
    NodeWeight solution_second_weight = pop.create_solution(G, solution_second);
    out_second.solution = solution_second;
    out_second.solution_weight = solution_second_weight;
