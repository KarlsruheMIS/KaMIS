...
inline graph_extractor::graph_extractor() {
...
inline void graph_extractor::extract_block(graph & G, 
...
template <typename graph>
inline void graph_extractor::extract_two_blocks(graph& G, 
...
template <typename graph>
inline void graph_extractor::extract_two_blocks_connected(graph& G, 
