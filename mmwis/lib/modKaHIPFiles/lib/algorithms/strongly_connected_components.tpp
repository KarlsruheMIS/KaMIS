...
inline int strongly_connected_components::strong_components( graph & G, std::vector<int> & comp_num) {
...
template <typename graph>
inline void strongly_connected_components::explicit_scc_dfs(NodeID node, graph & G){ 
