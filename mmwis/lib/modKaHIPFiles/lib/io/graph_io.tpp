...
inline void graph_io::writeVector(std::vector<vectortype> &vec, const std::string &filename)
{
...
template <typename vectortype>
inline void graph_io::readVector(std::vector<vectortype> &vec, const std::string &filename)
{
...
template <typename graph>
inline void graph_io::writePartition(graph& G, const std::string & filename) {
        std::ofstream f(filename.c_str());
