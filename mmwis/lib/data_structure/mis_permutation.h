...
class mis_permutation {
       ...
       public:
        ...
        /**
         * Returns vector of improvements by (w,1)-swap 
         *
         * @param node Node for which the position should be returned.
         * @return  vector of improvements by (w,1)-swap
         */
        std::vector<int> get_omega_improvements();
       ...
       private:
        ...
        // Array containing improvement possibility for (w,1) swap for each node.
        std::vector<int> omega_improvements;
